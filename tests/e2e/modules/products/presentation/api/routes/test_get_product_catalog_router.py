...
class TestGetProductCatalogRouter:
    @pytest.mark.asyncio
    async def test_should_return_200_with_empty_catalog(
        self,
        ...
        assert body["message"] == "Product catalog retrieved successfully."
        assert body["data"]["products"] == []

    @pytest.mark.asyncio
    async def test_should_return_200_with_products_in_catalog(
        self,
        async_client: AsyncClient,
        faker: Faker,
        ...
        supplier_token = await access_token_factory(
        ...
        buyer_token = await access_token_factory(
            str(created_buyer.email),
            str(plain_password_valid),
        )
    ...
    @pytest.mark.asyncio
    async def test_should_filter_catalog_by_name(
        self,
        async_client: AsyncClient,
        created_buyer: UserEntity,
        plain_password_valid: PlainPasswordVO,
    ...
    @pytest.mark.asyncio
    async def test_should_filter_catalog_by_unit_of_measure(
        self,
        async_client: AsyncClient,
        created_buyer: UserEntity,
        plain_password_valid: PlainPasswordVO,
        ...
        response = await async_client.get(
            f"/api/v1/products/?unit_of_measure={UnitOfMeasureEnum.KG.value}",
            headers={"Authorization": f"Bearer {access_token}"},
        )
    ...
    @pytest.mark.asyncio
    async def test_should_return_paginated_catalog(
        self,
        async_client: AsyncClient,
        created_buyer: UserEntity,
        plain_password_valid: PlainPasswordVO,
    ...
    @pytest.mark.asyncio
    async def test_should_return_403_when_authenticated_user_is_supplier(
        self,
        async_client: AsyncClient,
        faker: Faker,
    ) -> None:
    ...
    async def test_should_return_422_when_unit_of_measure_is_invalid(
        ...
        response = await async_client.get(
            "/api/v1/products/?unit_of_measure=INVALID",
            headers={"Authorization": f"Bearer {access_token}"},
        )
